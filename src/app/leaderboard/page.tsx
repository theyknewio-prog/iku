...
export const metadata: Metadata = {
  ...
  description:
    "Top 100 iku.gg fans by score. Compete, climb the ranks, earn rewards.",
    ...
    <main className="lb-page">
      <div className="lb-container">
        <div className="lb-hero">
          ...
          <p className="lb-sub">
            The top 100 iku.gg fans ranked by total score. Earn points by
            watching clips, adding favorites, and keeping your daily streak
            alive.
          </p>
          <div className="lb-tiers">
            {TIERS.map((t) => (
              ...
              >
                ...
                <span className="lb-tier-pill__threshold">
        ...
        {entries.length === 0 ? (
          <div className="lb-empty">
            <p>
              No one has scored yet. Be the first — start watching and climbing.
            </p>
            <Link href="/" className="lb-empty-btn">
              Browse clips
            </Link>
          </div>
        ) : (
            ...
            {entries.map((e, i) => {
              ...
              return (
                <li
                  ...
                  style={
                    isTop3 ? { borderColor: `${e.tier.color}66` } : undefined
                  }
                >
                  ...
                  <div
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${e.tier.color}, #c084fc)`,
                    }}
                  >
                    {e.avatar_emoji || "🌸"}
                  </div>
        ...
        <div className="lb-cta">
          ...
          <div className="lb-cta-buttons">
            <Link href="/" className="lb-cta-btn lb-cta-btn--primary">
              Start watching
            </Link>
            <Link href="/profile" className="lb-cta-btn">
              Your profile
            </Link>
          </div>
        </div>
