  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            style={{ padding: "4px 12px 10px", fontSize: 16, fontWeight: 500 }}
          >
            You
          </div>
          {[
          ...
          {main.slice(0, 8).map((v, i) => (
            ...
            >
              ...
              <div style={{ display: "flex", gap: 12 }}>
                ...
                >
                  {fmtName(v.characters[0] || v.copyrights[0] || "iku").charAt(
                    0,
                  )}
                </div>
                <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ display: "flex", gap: 12 }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 12, color: "#aaa", marginBottom: 2 }}>
                    {v.characters[0] ? fmtName(v.characters[0]) : "iku Studios"}{" "}
