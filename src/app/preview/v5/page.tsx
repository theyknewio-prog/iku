    ...
    >
      ...
      <header style={{ background: "#000", borderBottom: "2px solid #ff0000" }}>
        ...
        >
          ...
          <input
            placeholder="Search 353,000+ videos..."
            style={{
              flex: 1,
              maxWidth: 560,
              padding: "8px 14px",
          ...
          {[
            ...
            <Link
              ...
              style={{
                ...
                color: n.active ? "#fff" : "#bbb",
                textDecoration: "none",
                borderBottom: n.active
                  ? "3px solid #ff0000"
        ...
        {categories.map((c, i) => (
          <Link
            ...
            href={
              c === "Trending"
                ? "/trending"
                : `/tag/${encodeURIComponent(c.toLowerCase().replace(/ /g, "_"))}`
            }
            style={{
              padding: "6px 14px",
              background: i === 0 ? "#ff0000" : "#444",
              color: "#fff",
              fontSize: 12,
              fontWeight: 600,
              textDecoration: "none",
      ...
      >
        ...
        {["Trending", "New", "Top Rated", "Most Viewed", "Longest"].map(
          (s, i) => (
            <button
              key={s}
              style={{
                ...
                border: "none",
                cursor: "pointer",
                color: i === 0 ? "#ff7a00" : "#ccc",
                fontSize: 13,
                fontWeight: i === 0 ? 700 : 500,
                borderBottom:
                  i === 0 ? "2px solid #ff7a00" : "2px solid transparent",
                paddingBottom: 4,
              }}
            >
              {s}
