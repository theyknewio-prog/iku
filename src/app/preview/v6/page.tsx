...
export default async function V6() {
  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{ padding: "18px 16px", borderBottom: "1px solid #e5e8ec" }}
        >
          <Link
            href="/preview/v6"
            style={{
      ...
      {/* ── CENTER FEED ───────────────────────────────────────── */}
      <section
        style={{ flex: 1, minWidth: 0, maxWidth: 680, padding: "24px 28px" }}
      >
        <div
          style={{
            background: "linear-gradient(135deg, #00aff0 0%, #0084d1 100%)",
          ...
          {posts.map((p, i) => (
            ...
            >
              ...
              >
                ...
                <span
                  style={{ marginLeft: "auto", fontSize: 12, color: "#8395a7" }}
                >
      ...
      >
            ...
            {suggested.map((c, i) => (
              <div
                ...
                style={{
                  ...
                  padding: "10px 16px",
                  borderBottom:
                    i === suggested.length - 1 ? "none" : "1px solid #f0f2f5",
                }}
              >
                <div
                  style={{
                ...
                <div style={{ minWidth: 0, flex: 1 }}>
                  ...
                  <div style={{ fontSize: 11, color: "#8395a7" }}>
                    {fmtViews(c.count)} posts ·{" "}
                    {i % 3 === 0
                      ? "FREE"
                      : `${(2.99 + (i % 3)).toFixed(2)}€/mo`}
                  </div>
                </div>
                <button
                  style={{
        ...
        >
          ...
          <Link
            href="/help"
            style={{ color: "#8395a7", textDecoration: "none" }}
          >
            Help
          </Link>
