          ...
          {videos.map((v) => (
            ...
            >
              ...
              <div style={{ fontSize: 11, color: "rgba(255,255,255,0.5)" }}>
                <span style={{ color: "#ffd700" }}>★★★★★</span> {fmt(v.score)}{" "}
                views
              </div>
            </Link>
          ))}
        ...
        >
          ...
          >
            ...
            >
              ...
              {cmdQuery &&
                cmdResults.navHits.length +
                  cmdResults.tagHits.length +
                  cmdResults.charHits.length ===
                  0 && (
                  <div
                    style={{
                      padding: "24px 16px",
            ...
            >
              ...
              <span>
                <kbd style={kbd}>⌘\</kbd> toggle sidebar
              </span>
            </div>
          </div>
        </div>
...
function SidebarItem({
  ...
  return (
    ...
    >
      <span
        style={{ fontSize: 18, width: 22, textAlign: "center", flexShrink: 0 }}
      >
        {item.icon}
      </span>
      {expanded && (
        <>
          <span
            style={{ flex: 1, fontSize: 13, fontWeight: active ? 700 : 500 }}
          >
            {item.label}
          </span>
          <kbd
            style={{ ...kbd, fontSize: 10, opacity: hover || active ? 1 : 0 }}
          >
            {item.shortcut}
          </kbd>
        </>
