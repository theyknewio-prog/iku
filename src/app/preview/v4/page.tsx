...
export default async function V4() {
  const [trending, topRated, newest, games] = await Promise.all([
    getVideos({ limit: 8, order: "score", source: "all", requireThumbnail: true }),
  ...
  return (
    <main style={{
      ...
      <header style={{
        ...
        <Link href="/preview/v4" style={{
          ...
          <span style={{
            ...
            background: "linear-gradient(135deg, #ff006e 0%, #ffbe0b 50%, #8338ec 100%)",
        ...
        <nav style={{ display: "flex", gap: 6, marginLeft: 20, flex: 1, overflowX: "auto" }}>
          {[
            { emoji: "🎲", label: "Lucky" },
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <input placeholder="🔎 Search..." style={{
            padding: "10px 16px", borderRadius: 999, width: 220,
          ...
          <Link href="/pricing" style={{
            ...
            color: "#1a0312", fontSize: 14, fontWeight: 900,
      ...
      {featured && (
        <section style={{
          ...
          <div style={{
            ...
            background: "linear-gradient(135deg, #ff006e 0%, #8338ec 50%, #3a0ca3 100%)",
            padding: "4px",
            boxShadow: "0 0 60px rgba(255,0,110,0.45), 0 0 120px rgba(131,56,236,0.35)",
          }}>
            <div style={{
              ...
              <div style={{ padding: "8px 6px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                <div style={{
                  display: "inline-flex", alignItems: "center", gap: 6, padding: "3px 10px",
                  background: "rgba(255,190,11,0.18)", borderRadius: 999, alignSelf: "flex-start",
                  fontSize: 11, fontWeight: 800, color: "#ffbe0b", letterSpacing: "0.08em", textTransform: "uppercase",
                ...
                <h1 style={{
                  fontSize: 34, fontWeight: 900, lineHeight: 1.1, letterSpacing: "-0.02em",
                  marginBottom: 12,
                  background: "linear-gradient(135deg, #fff 0%, #ffbe0b 100%)",
                  WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent",
                }}>
                  {buildTitle(featured)}
                </h1>

                <p style={{ fontSize: 14, lineHeight: 1.5, color: "rgba(255,255,255,0.8)", marginBottom: 18 }}>
                  🐰 <strong>360,000+ clips</strong> of hentai, 3D cartoon porn, SFM compilations & TikTok shorts.
                  Nothing to install, nothing to pay. Spin the wheel and find your obsession.
                </p>
                ...
                <div style={{ display: "flex", gap: 16, marginTop: 22, fontSize: 11, color: "rgba(255,255,255,0.55)" }}>
                  <span>
      ...
      {/* ── HOT RIGHT NOW row ──────────────────────────── */}
      <section style={{ position: "relative", zIndex: 5, padding: "8px 28px 32px" }}>
        <h2 style={{
          fontSize: 22, fontWeight: 900, marginBottom: 14,
            ...
            <Link key={v.id} href={`/watch/${v.slug}`} style={{
              ...
              <div style={{ position: "relative", aspectRatio: "16/9", background: "#000" }}>
                ...
                <div style={{
                  ...
                  background: i === 0 ? "linear-gradient(135deg, #ffbe0b, #ff006e)" : "rgba(0,0,0,0.78)",
                ...
                {v.duration && (
                  <span style={{
                    ...
                    padding: "3px 8px", background: "rgba(0,0,0,0.78)",
              ...
              <div style={{ padding: "10px 12px 12px" }}>
                <div style={{ fontSize: 13, fontWeight: 700, lineHeight: 1.3, marginBottom: 6, overflow: "hidden", textOverflow: "ellipsis", display: "-webkit-box", WebkitLineClamp: 1, WebkitBoxOrient: "vertical" }}>
                  {buildTitle(v)}
                </div>
                <div style={{ fontSize: 11, color: "rgba(255,255,255,0.55)" }}>
                  <span style={{ color: "#ffbe0b" }}>★★★★★</span>
                  <span style={{ marginLeft: 6 }}>{formatViews(v.score)} views</span>
                </div>
              </div>
            </Link>
          ))}
          ...
          {games.map((g, i) => {
            ...
            return (
              <Link key={g.name} href={`/series/${encodeURIComponent(g.name)}`} style={{
                position: "relative", padding: "20px 16px", borderRadius: 16,
                ...
                <div style={{
                  position: "absolute", top: -10, right: -10, fontSize: 64, opacity: 0.25,
                }}>
                  🎰
                </div>
                <div style={{ fontSize: 15, fontWeight: 900, marginBottom: 4, textShadow: "0 2px 4px rgba(0,0,0,0.3)" }}>
                  {formatName(g.name)}
                </div>
            ...
            <Link key={v.id} href={`/watch/${v.slug}`} style={{
              ...
              <div style={{ position: "relative", aspectRatio: "16/9", background: "#000" }}>
                ...
                <span style={{
                  ...
                  fontSize: 10, fontWeight: 900, color: "#1a0312",
                }}>
                  💎 VIP
                </span>
              </div>
              <div style={{ padding: "10px 12px 12px" }}>
                ...
                <div style={{ fontSize: 11, color: "rgba(255,255,255,0.55)" }}>
                  <span style={{ color: "#ffbe0b" }}>★★★★★</span>
                  <span style={{ marginLeft: 6 }}>{formatViews(v.favorites)} ❤</span>
                </div>
              </div>
            </Link>
          ))}
      ...
      {/* ── Footer ────────────────────────────────────── */}
      <footer style={{ position: "relative", zIndex: 5, padding: "32px 28px 80px", textAlign: "center", color: "rgba(255,255,255,0.4)" }}>
        <div style={{ fontSize: 36, marginBottom: 10 }}>🐰💋💎</div>
        <div style={{ fontSize: 13, fontWeight: 700, color: "#ffbe0b", marginBottom: 4 }}>
          iku.club — the bunny&apos;s adult arcade
        </div>
        <div style={{ fontSize: 11 }}>
          © 2026 iku.gg — All models 18+ · <Link href="/dmca" style={{ color: "#ff006e" }}>DMCA</Link> · <Link href="/privacy" style={{ color: "#ff006e" }}>Privacy</Link>
        </div>
      </footer>
