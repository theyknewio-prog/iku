    ...
    >
      ...
      <nav
        style={{
          ...
          background:
            "linear-gradient(180deg, rgba(6,3,9,0.92) 0%, rgba(6,3,9,0) 100%)",
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(180deg, rgba(6,3,9,0) 30%, rgba(6,3,9,0.85) 80%, #060309 100%), linear-gradient(90deg, rgba(6,3,9,0.85) 0%, rgba(6,3,9,0) 60%)",
            }}
          />
          ...
          <div style={{ position: "relative", zIndex: 2, maxWidth: 620 }}>
            ...
            >
              The largest free hentai + 3D cartoon porn library.{" "}
              {formatViews(trending.data.reduce((a, v) => a + v.score, 0))}+
              views this week. Stream instantly, no signup.
            </p>
      ...
      >
        <div style={{ maxWidth: 1400, margin: "0 auto" }}>
          ...
          <p>
            © 2026 iku.gg — All models are 18+. A premium streaming experience.
          </p>
        </div>
      </footer>
    </main>
