...
export default async function V7() {
  const [hero, continueW, newEps, topSeries, series, genres] =
    await Promise.all([
      getVideos({
        limit: 1,
        order: "score",
  ...
  return (
    ...
    >
          ...
          >
            <input
              ...
              style={{
                ...
                width: 220,
                backgroundImage:
                  "url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2214%22 height=%2214%22 fill=%22%23888%22><circle cx=%226%22 cy=%226%22 r=%224%22 fill=%22none%22 stroke=%22%23888%22 stroke-width=%222%22/><line x1=%229%22 y1=%229%22 x2=%2213%22 y2=%2213%22 stroke=%22%23888%22 stroke-width=%222%22/></svg>')",
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(180deg, rgba(11,15,26,0) 20%, rgba(11,15,26,0.9) 85%, #0b0f1a 100%), linear-gradient(90deg, rgba(11,15,26,0.88) 0%, rgba(11,15,26,0) 55%)",
            }}
          />
          <div
            style={{
            ...
            <div style={{ maxWidth: 580 }}>
              ...
              >
                {featured.copyrights[0]
                  ? fmtName(featured.copyrights[0])
                  : buildTitle(featured).slice(0, 48)}
              </h1>
              <div
                style={{
                  display: "flex",
              ...
              >
                {buildTitle(featured)}. {fmtViews(featured.score)} total
                watches. New episode every Thursday.
              </p>
          ...
          {continueW.data.map((v, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  {v.copyrights[0]
                    ? fmtName(v.copyrights[0])
                    : buildTitle(v).slice(0, 40)}
                </div>
        ...
        >
          {topSeries.data.map((v, i) => (
            ...
            >
              ...
              >
                {(v.tags[0] || "hentai").replace(/_/g, " ")} ·{" "}
                {Math.floor(v.score / 500) + 12} eps
              </div>
            </Link>
          ))}
        </div>
      ...
      <section style={{ padding: "40px 32px" }}>
        ...
        <div
          style={{ marginTop: 36, display: "flex", gap: 8, flexWrap: "wrap" }}
        >
          {series.map((s) => (
            <Link
              key={s.name}
