      ...
      <main>
        <div className="page-container">
          ...
          <div className="tag-hero">
            ...
            {/* SEO intro — pulled from entity_seo PG table (per-tag unique
                 3-paragraph body + 3 FAQ pairs, generated by
                 scripts/enrich-entity-seo.mjs). Falls back to the legacy
                 templated paragraph for tags below the 50-video threshold. */}
            {entitySeo ? (
