              ...
              <article className="blog-post-main">
                ...
                {glossaryTerms.length > 0 && (
                  <section className="blog-glossary-links">
                    <h2 className="glossary-related-heading">Terms in This Article</h2>
                    <div className="glossary-grid">
                      {glossaryTerms.map((term) => (
                        ...
                        >
                          ...
                          <span className="glossary-card__cta">Definition →</span>
                        </Link>
                      ))}
                    </div>
                  </section>
                ...
                {(() => {
                  ...
                  if (!internalLinks || internalLinks.linksToAdd.length === 0) return null;
                  return (
                    <section className="blog-glossary-links" style={{ marginTop: "32px" }}>
                      <h2 className="glossary-related-heading">Related Content on iku.gg</h2>
                        ...
                        {internalLinks.linksToAdd.map((link) => (
                          <li key={link.href}>
                            <Link
                              ...
                              style={{ display: "inline-block", fontSize: "var(--text-sm)" }}
                            >
                              {link.text}
                            </Link>
                          </li>
                ...
                <div style={{ marginTop: "32px" }}>
                  <Link href="/blog" className="btn btn-ghost btn-sm">← Back to Blog</Link>
                </div>
              </article>
                ...
                <aside className="blog-post-sidebar">
                  ...
                  <div className="blog-sidebar-list">
                    {relatedArticles.map((rel) => (
                      <Link key={rel.slug} href={`/blog/${rel.slug}`} className="blog-sidebar-item">
                        <span className="blog-sidebar-item__title">{rel.title}</span>
                        <span className="blog-sidebar-item__read">{rel.readingTime} min read</span>
                      </Link>
                    ))}
                  </div>
                  ...
                  <div style={{ marginTop: "32px" }}>
                    ...
                    <div className="blog-sidebar-list">
                      <Link href="/glossary" className="blog-sidebar-item">
                        <span className="blog-sidebar-item__title">Hentai Glossary</span>
                      </Link>
                      <Link href="/trending" className="blog-sidebar-item">
                        <span className="blog-sidebar-item__title">Trending Videos</span>
                      </Link>
                      <Link href="/tags" className="blog-sidebar-item">
                        <span className="blog-sidebar-item__title">Browse All Tags</span>
                      </Link>
                    </div>
                  </div>
                </aside>
