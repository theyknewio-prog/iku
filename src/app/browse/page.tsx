  ...
  return (
    <div>
      ...
      <header className="site-header">
        <div className="site-header__inner">
          ...
          <nav className="site-header__nav" aria-label="Main navigation">
            ...
            <Link href="/browse" className="nav-link nav-link--active">Browse</Link>
          </nav>
        </div>
      </header>
        ...
        <div className="page-container">
          ...
          <section className="page-section">
            ...
            <div className="tag-grid-featured">
              {popularTags.map((tag) => (
                <Link key={tag.name} href={`/tags/${tag.name}`} className="tag-card">
          ...
          <section className="page-section">
            ...
            <div className="tag-grid-featured">
              {popularCharacters.map((char) => (
                <Link key={char.name} href={`/tags/${char.name}`} className="tag-card">
      ...
      <nav className="bottom-nav" aria-label="Mobile navigation">
        ...
        <Link href="/browse" className="bottom-nav__item bottom-nav__item--active">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
