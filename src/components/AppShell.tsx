        ...
        <div className="v2-user-dropdown" role="menu">
          <div className="v2-user-dropdown__header">
            ...
            <div>
              ...
              <div className="v2-user-dropdown__email">
                {session.user.email}
              </div>
            </div>
          </div>
          <Link
            href="/profile"
            className="v2-user-dropdown__item"
  ...
  function renderNavItem(item: NavItem) {
    ...
    return (
      ...
      >
        ...
        {item.badge && (
          <span
            className={`v2-nav-badge${item.badgeGradient ? " v2-nav-badge--gradient" : ""}`}
          >
            {item.badge}
          </span>
        )}
  ...
  return (
    <>
      <div className="v2-shell">
        ...
        {/* TOPBAR */}
        <header
          className={`v2-topbar${scrolled ? " v2-topbar--scrolled" : ""}`}
        >
          ...
          <div className="v2-topbar__actions">
            ...
            >
              <span className="v2-topbar-pro-cta__short" aria-hidden>
                PRO
              </span>
        ...
        <div className="v2-main">
          ...
          <nav className="v2-subnav" aria-label="Primary formats">
            <div className="v2-subnav__scroll">
              <Link
                href="/"
                className={`v2-subnav__pill${pathname === "/" ? " v2-subnav__pill--active" : ""}`}
              >
                <span aria-hidden="true">🏠</span> Home
              </Link>
              <Link
                href="/hentai"
                className={`v2-subnav__pill${isActive("/hentai") ? " v2-subnav__pill--active" : ""}`}
              >
                <span aria-hidden="true">🌸</span> Hentai 2D
              </Link>
              <Link
                href="/3d"
                className={`v2-subnav__pill${isActive("/3d") ? " v2-subnav__pill--active" : ""}`}
              >
              ...
              <Link
                href="/feed"
                className={`v2-subnav__pill v2-subnav__pill--shorts${isActive("/feed") ? " v2-subnav__pill--active" : ""}`}
              >
                <span aria-hidden="true">⚡</span> Shorts
              </Link>
              <Link
                href="/trending"
                className={`v2-subnav__pill${isActive("/trending") ? " v2-subnav__pill--active" : ""}`}
              >
      ...
      <nav className="v2-bottom-nav" aria-label="Mobile navigation">
        {BOTTOM_ITEMS.map(({ href, label, Icon, featured }) => (
          ...
          >
            {featured ? (
              <span
                className={`v2-shorts-icon-wrap${isActive(href) ? " v2-shorts-icon-wrap--active" : ""}`}
              >
                <Icon size={20} />
              </span>
            ) : (
          ...
          >
            ...
            <div className="v2-nav-drawer__body">
              ...
              {[
                {
                  label: "Watch",
                  items: DISCOVER_ITEMS as unknown as NavItem[],
                },
                { label: "Fresh", items: FRESH_ITEMS as unknown as NavItem[] },
                {
                  label: "Browse",
                  items: BROWSE_ITEMS as unknown as NavItem[],
                },
                {
                  label: "My Library",
                  items: LIBRARY_ITEMS as unknown as NavItem[],
                },
                {
                  label: "Account",
                  items: ACCOUNT_ITEMS as unknown as NavItem[],
                },
              ].map((group) => (
                <div key={group.label} className="v2-nav-drawer__section">
                  <div className="v2-nav-drawer__section-label">
                    {group.label}
                  </div>
                  {group.items.map((item) => (
                    ...
                    >
                      ...
                      {item.badge && (
                        <span
                          className={`v2-nav-drawer__badge${item.badgeGradient ? " v2-nav-drawer__badge--gradient" : ""}`}
                        >
                          {item.badge}
                        </span>
                      )}
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="v2-nav-drawer__telegram"
                onClick={() => setMenuOpen(false)}
              >
                <svg
                  viewBox="0 0 24 24"
                ...
                <div>
                  ...
                  <small>New drops · instant notifs</small>
                </div>
              </a>
            </div>
          </aside>
