...
export function middleware(request: NextRequest) {
  ...
  const csp = [
    "default-src 'self'",
    `script-src 'self' 'unsafe-inline' 'unsafe-eval' https://us-assets.i.posthog.com https://a.magsrv.com https://*.magsrv.com https://*.exoclick.com https://*.exosrv.com https://*.afcdn.net https://*.cam4.com https://*.tsyndicate.com https://www.topcreativeformat.com https://*.topcreativeformat.com https://*.adsterra.com https://*.adsterratech.com https://static.cloudflareinsights.com https://*.cloudflareinsights.com https://*.mbjms.com https://*.imglnkx.com https://*.crakrevenue.com https://cdn.onesignal.com https://*.onesignal.com`,
    "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
    "font-src 'self' https://fonts.gstatic.com",
    "img-src 'self' data: blob: https://cdn.donmai.us https://gelbooru.com https://*.gelbooru.com https://rule34.xxx https://*.rule34.xxx https://rule34video.com https://*.rule34video.com https://hentaimama.io https://hentai.tv https://animeidhentai.com https://watchhentai.net https://hentaiworld.tv https://hentaigasm.com https://hentaicity.com https://*.exoclick.com https://*.exosrv.com https://a.magsrv.com https://*.magsrv.com https://*.afcdn.net https://www.topcreativeformat.com https://*.topcreativeformat.com https://*.adsterra.com https://*.adsterratech.com https://onesignal.com https://*.onesignal.com",
