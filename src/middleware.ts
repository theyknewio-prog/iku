...
export function middleware(_request: NextRequest) {
  ...
  const csp = [
    ...
    "frame-src 'self' https://*.exoclick.com https://*.exosrv.com https://*.magsrv.com https://*.xlivrdr.com https://*.afcdn.net https://*.cam4.com https://*.tsyndicate.com https://*.chaturbate.com https://*.stripchat.com https://www.topcreativeformat.com https://*.topcreativeformat.com https://*.adsterra.com https://*.adsterratech.com https://*.profitablecpmratenetwork.com https://*.highperformanceformat.com",
