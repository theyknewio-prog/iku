...
export function middleware(request: NextRequest) {
  ...
  const csp = [
    ...
    "connect-src 'self' https://cdn.donmai.us https://danbooru.donmai.us https://gelbooru.com https://*.gelbooru.com https://rule34.xxx https://*.rule34.xxx https://rule34video.com https://*.rule34video.com https://us.i.posthog.com https://us-assets.i.posthog.com",
